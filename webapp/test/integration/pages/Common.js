sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("opensap/manageproduts/app", ".html");
		...
		return Opa5.extend("opensap.manageproduts.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["opensap/manageproduts/localService/mockserver"], function (mockserver) {
